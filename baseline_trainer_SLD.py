...
from models.sld import HierarchicalPredictor, NUM_EMO
...
def main():
    ...
    def one_fold(num_fold, train_index, dev_index):
        ...
        # To prevent model diverge, once it happens, retrain
        while True:
            is_diverged = False
    ...
    f_out = open('test_SLD' + opt.postname + '.txt', 'w')
